...
function getBooksSpecifics(type) {
    ...
    switch (type) {
        case 0:
            ...
            break;
        case 1:
            showMystery.classList.add('active');
            break;
        case 2:
            showAdventure.classList.add('active');
            break;
        case 3:
            showBoxes.classList.add('active');
            break;
        case 4:
            showTerror.classList.add('active');
            break;
        case 5:
            showFantasy.classList.add('active');
            break;
    }
}
